describe('Gumga.core:MaxDate', () => {
	let compile, scope, filter, controller;

	beforeEach(module('gumga.form.min.date'));
	beforeEach(module('gumga.form.form'));
	...
	it('should valid input value', () => {
		...
		expect(controller.changeStateOfInput).toHaveBeenCalledWith('nascimento', 'mindate', false, '1980-10-10', undefined);
	...
	it('should invalid input value', () => {
		...
		expect(controller.changeStateOfInput).toHaveBeenCalledWith('nascimento', 'mindate', true, '1980-10-10', undefined);
