...
function ManyToMany($q, $compile, $timeout, $uibModal) {
  ...
  function controller($scope, $element, $attrs, $transclude) {
    ...
    ctrl.$onInit = () => {
      ...
      const hasObjectInRight = obj => (ctrl.rightList.filter(rightObject => {
...
const module = angular.module('gumga.manytomany', ['ui.bootstrap']).directive('gumgaManyToMany', ManyToMany);
