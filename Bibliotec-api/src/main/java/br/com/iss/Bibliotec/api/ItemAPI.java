...
import br.com.iss.Bibliotec.application.service.ItemService;
...
@Transactional
public class ItemAPI extends GumgaAPI<Item, Long> {


@Autowired
public ItemAPI(GumgaService<Item, Long> service) {
    super(service);
}
