package br.com.iss.infrastructure.config;
...
@Configuration
@ComponentScan(basePackages = {"br.com.iss", "io.gumga"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"br.com.iss", "io.gumga"})
...
public class Application {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain","br.com.iss");
