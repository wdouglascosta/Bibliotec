package br.com.iss.Bibliotec.boot;
...
@SpringBootApplication(scanBasePackages = {"br.com.iss.Bibliotec.boot.components",
                                           "br.com.iss.Bibliotec.application.service",
                                           "io.gumga",
                                           "br.com.iss.Bibliotec.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"br.com.iss.Bibliotec.application.repository", "io.gumga"})
...
public class Application {
    ...
    public DataSource dataSource() {
        ...
        config.addDataSourceProperty("url", getProperties().getProperty("dataSource.url", "jdbc:h2:mem:Bibliotec;MVCC=true"));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "br.com.iss.Bibliotec.domain.model");
